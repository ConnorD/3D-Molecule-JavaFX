package cs351.connordenman.molecule3d;
 ...
 *
 * This class renders models for the molecules methane (CH4) and water (H20) with some UI control.
 * Much of the code is based off the tutorial:
